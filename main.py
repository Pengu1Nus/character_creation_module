...
def attack(char_name: str, char_class: str) -> str:
    """Print information how much damage player did,.
    according to his class.

    Args:
        char_name (str): name of users char
        char_class (str): users class

    Returns:
        str: string information about how much damage did player.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Print information how much damage player blocked,.
    according to his class.
    ...
    Returns:
        str: string information about how much damage player blocked.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Print information about player cast special class ability,.
    according to his class.
    ...
    Returns:
        str: string information about player cast special class ability.
    """
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Print information about players training info.
    ...
    Returns:
        str: information about players training info.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Suggest to user enter his name and choose char class to play.

    Returns:
        str: information about which class user select.
    """
    approve_choice: str = ''
    char_class: str = ''
